    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 p-10">
        ...
        <div class="flex flex-col gap-3">
            ...
            <ul class="flex flex-col gap-2 text-white">
                <li><a class="hover:text-[#6d7b40]" href="{{ route('page.show', ['slug' => 'za-nas']) }}"
                        title="aboutUs">{{ trans('app.aboutUs') }}</a></li>
                <li><a class="hover:text-[#6d7b40]" href="{{ route('page.show', ['slug' => 'obshti-uslovia']) }}"
                        title="generalConditions">{{ trans('app.generalConditions') }}</a></li>
                <li><a class="hover:text-[#6d7b40]" href="{{ route('page.show', ['slug' => 'poveritelnost']) }}"
                        title="privacyPolicy">{{ trans('app.privacyPolicy') }}</a></li>
                <li><a class="hover:text-[#6d7b40]" href="{{ route('page.show', ['slug' => 'reklama']) }}"
                        title="advertIsement">{{ trans('app.advertIsement') }}</a></li>
                <li><a class="hover:text-[#6d7b40]" href="{{ route('contacts') }}"
                        title="contactUs">{{ trans('app.contactUs') }}</a></li>
            </ul>
        </div>
        <div class="flex flex-col gap-3">
            ...
            <ul class="flex flex-col gap-2 text-white">
                ...
                @if ($areas->count() > 5)
                    <li>
                        ...
                        <a href="{{ route('category.listing.layout', ['categoryName' => 'areas']) }}"
                            class="hover:text-[#6d7b40]">
