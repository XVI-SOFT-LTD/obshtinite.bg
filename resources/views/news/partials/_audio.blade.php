    ...
    <div class="entry__thumb">
        <a href="single-audio.html" class="entry__thumb-link">
            <img src="{{ config('app.paths.img') }}/thumbs/masonry/guitarman-400.jpg"
                srcset="{{ config('app.paths.img') }}/thumbs/masonry/guitarman-400.jpg 1x, {{ config('app.paths.img') }}/thumbs/masonry/guitarman-800.jpg 2x" alt="">
        </a>
    ...
    <div class="entry__text">
        ...
        <div class="entry__meta">
            <span class="entry__meta-links">
                <a href="{{ route('category') }}">Music</a>
                <a href="{{ route('category') }}">Lifestyle</a>
            </span>
        </div>
    </div>
